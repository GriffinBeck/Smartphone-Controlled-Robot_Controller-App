...
public class JoystickView extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener {
    ...
    public JoystickView(final Context context) {
        ...
        if (context == null)
            Log.e("Joystick", "Listner is null 1");
        getHolder().addCallback(this);
        setOnTouchListener(this);
        //if(context instanceof JoystickListener)
        //joystickCallback = (JoystickListener) context;
        if (context != null && context instanceof JoystickListener) {
            joystickCallback = (JoystickListener) context;
            Log.e("Joystick", "Listner is NOT null 1");
            if (joystickCallback == null) {
                Log.e("Joystick", "Listner is  NOW null WRFSDASFDFWQFSA 1");
            }
        }
    }
